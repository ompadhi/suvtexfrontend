...
import expertTeamBg from '@/assets/BACKGROUND/EXPERT TEAM.webp'

// Import technologist images
import footwearImg from '@/assets/Our Technologists/FOOTWEAR.webp'
import leatherImg from '@/assets/Our Technologists/LEATHER.webp'
import nonStickImg from '@/assets/Our Technologists/Non-Stick.webp'
import toyImg from '@/assets/Our Technologists/TOY TECHNOLOGIST.webp'
import homeTextileImg from '@/assets/Our Technologists/home textile.webp'
import plasticImg from '@/assets/Our Technologists/plastic.webp'
import textileImg from '@/assets/Our Technologists/textile.webp'
import utensilsImg from '@/assets/Our Technologists/utensils.webp'
import innerWearImg from '@/assets/Our Technologists/INNERWEAR.webp'
import isoLogo from '@/assets/ISO LOGO.webp'
import sa8000Logo from '@/assets/sa 8000.webp'
    ...
    <div className="pt-28 pb-8">
      ...
      <section className="relative h-[400px] flex items-center overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-suvtex-charcoal/20 via-suvtex-charcoal/20 to-transparent"></div>
        </div>
        ...
        <div className="container-premium">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              { title: 'ISO 45001 Certified', logo: isoLogo },
