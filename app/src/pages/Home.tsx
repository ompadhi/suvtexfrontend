        ...
        <div className="container-premium relative z-10">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-2 space-y-6">
              <ScrollReveal>
                <SectionLabel text="Contact Us" className="mb-4" />
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Last Name <span className="text-suvtex-orange">*</span></label>
                          <input 
                            type="text" 
                            name="lastName"
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="block text-xs font-bold text-gray-700 mb-1.5 uppercase tracking-wide">Whatsapp Number <span className="text-suvtex-orange">*</span></label>
                          <input 
                            type="tel" 
                            name="phone"
