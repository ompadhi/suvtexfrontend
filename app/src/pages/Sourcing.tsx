        ...
        <div className="relative z-10 container-premium">
          <ScrollReveal className="max-w-3xl">
            ...
            <p className="text-white font-bold max-w-2xl text-lg drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              We support end-to-end product sourcing and order fulfillment, ensuring consistent quality, full compliance, and on-time delivery. Backed by a reliable network of manufacturing partners across Mumbai, India, we work with facilities certified to global standards such as ISO, SMETA, BSCI, WRAP, OEKO-TEX® Standard 100, GOTS, and BIS.
            </p>
          </ScrollReveal>
        </div>
      </section>
